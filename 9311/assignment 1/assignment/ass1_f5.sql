...
create table Users (
	...
	foreign key (billingAddress) references Places(id) ,    --billingAddress relationship
	foreign key (homeAddress) references Places(id)    --homeAddress relationship
);
...
create table InstanceOf (
    ...
    foreign key (repeatingEventsInID) references RepeatingEvents (id)
);
