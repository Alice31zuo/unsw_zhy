...
#query parameters to pass the column name and order type .
...
#create a new class to get all books
@api.route('/books')
class BooksList(Resource):

# indicate which HTTP response code does each method returns and what they mean
