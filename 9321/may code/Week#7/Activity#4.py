...
def get_book(id):
    #Send a get request to get the book with id=206,
...
def remove_book(id):
    ...
    r = requests.delete("http://127.0.0.1:5000/books/"+str(id))
...
if __name__ == '__main__':
    ...
    #send a get request to get the book with id=206 to see if the book doesn't exist
    book = get_book(206)