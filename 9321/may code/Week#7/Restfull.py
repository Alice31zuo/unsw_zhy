...
book_model = api.model('Book', {
    ...
    'Title': fields.String,
    'Date_of_Publication': fields.Float,
...
#indicating which HTTP response code does each method returns and what they mean
    @api.response(200, 'Successful')

#adding descriptions for API methods
...
#adding descriptions for the parameters
